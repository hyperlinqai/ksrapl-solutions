            ...
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
                        See NUVO Auto Technologies Pvt Ltd in Action
                    </h2>
                ...
                >
                    <div style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
                        <iframe
                            src={`https://player.vimeo.com/video/1160218630?badge=0&autopause=0&player_id=0&app_id=58479${playVideo ? "&autoplay=1&muted=1" : ""}`}
                            frameBorder="0"
