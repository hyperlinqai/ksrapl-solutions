        ...
        <section className="container mx-auto max-w-6xl mb-16">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed relative z-10">
              NUVO Auto Technologies Pvt Ltd practices the highest level of quality assurance, driving precise outcomes through training, error-proofing, and disciplined processes.
            </p>
